...
namespace DynamicLocalization
{
    public static class LocUtil
    {
        ...
        /// </summary>
        public static void SwitchLanguage( FrameworkElement element, string CharLang )
        {
            ...
            Thread.CurrentThread.CurrentUICulture = new CultureInfo(CharLang);

            SetLanguageResourceDictionary(element, GetLocXAMLFilePath(getElementName(element), CharLang));
            ...
            UserPrefs.SetValue(getElementName(element) + ".localization", CharLang);
        }
        ...
        /// <returns></returns>
        public static string GetLocXAMLFilePath( string element, string CharLang )
        {
            string locXamlFile = "Language" + "." + CharLang + ".xaml";
            string directory = @"C:\Users\Sanket\Desktop\EPAS\EPAS";
